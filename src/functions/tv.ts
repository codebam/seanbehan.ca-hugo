async function modifyPage(response: Response) {
  ...
  const head_tags_subst = `\<head\>$1<meta property="og:title" content="codebam.tv"><meta property="og:site_name" content="codebam.tv"><meta property="og:type" content="video.other"><meta property="og:image" content="https://codebam.tv/tv-favicon.png">`;
  const head_adsense_subst = `\<head\>$1<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3287237463323384"\n     crossorigin="anonymous"></script>`;
